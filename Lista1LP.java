...
public class Lista1LP {
	...
	//A e B, lidos através do teclado.
			...
			if (A > B) {
				System.out.println("O valor de A que é: " + A + " é maior que o valor de B que é: " + B);
			}
			else {
				System.out.println("O valor de B que é: " + B + " é maior que o valor de A que é: " + A);
				}
	...
	//- Se quantidade > 10 o desconto será de 5%
			...
			if (qtd <= 5) {
				...
				System.out.println("O valor total a pagar é de: R$ " + totalPagar);
				}
	...
	//Considere que o N será sempre maior que ZERO.
			...
			do {
				System.out.println("Digite um valor para a variável N: ");
					N = ler.nextInt();
				} while(N == 0);
	...
	//10 do valor lido.
			...
			System.out.println("Digite o número do qual você quer saber a tabuada: ");
				num = ler.nextInt();
	...
	//18) Escreva um algoritmo que imprima a tabuada (de 1 a 10) para os números de 1 a 10.
			...
			for (int p = 1; p <= 10; p++) {
				System.out.println("A tabuada de " + p + " é: \n" );
	...
	//- a média aritmética dos preços dos produtos
			...
			for (int i = 1; i<= 15; i = i+1) {
				...
				//atualizando o maior preço lido
				if (preco > maiorPreco) {
					maiorPreco = preco;
						codigoProdutoMaiorPreco = codigo;
					}
					
				//acumulador dos preços, a soma de todos os preços lidos
				//possibilita fazer a média dos preços
				...
				System.out.println("O maior preço lido é: " + maiorPreco + " do produto de código: " + codigoProdutoMaiorPreco);
